  ...
  <div class="container">
    <div class="d-sm-flex text-center">
      <div class="align-self-center">
        <h2 class="h3 g-font-weight-300 w-100 g-mb-10 g-mb-0--md">Prescriptions</h2>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-9">
              ...
              @include('website.components.video_call_notification')
                ...
                <h2 class="h3 u-heading-v1__title">My Prescription</h2>
            </div>
                        @include('website.patient.components.prescriptions', ['prescriptions' => $prescriptions])
