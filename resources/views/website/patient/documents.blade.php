  ...
  <div class="container">
    <div class="d-sm-flex text-center">
      <div class="align-self-center">
        <h2 class="h3 g-font-weight-300 w-100 g-mb-10 g-mb-0--md">Documents</h2>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="u-heading-v1-4 g-bg-main g-brd-gray-light-v2 g-mb-20">
                <h2 class="h3 u-heading-v1__title">Documents</h2>
            </div>
             <div class="row pl-4 pr-4">
                    <div class="col-md-12 mb-5">
                        <div class="input-group mb-3 shadow-sm">
                            <input type="text" class="form-control" placeholder="{{ __('document.document') }}"/>
                        ...
                        @include('website.patient.components.documents',['documents'=>$documents])
