<div class="clearfix home appointment pt-4 pb-5">
    <svg
    ...
    >
        <defs>
            ...
            <linearGradient
                    ...
                    x2="619.77"
                    y2="58.66"
                    xlink:href="#fbf30545-21ed-4d00-b98c-956576520cc3"
            />
        </defs>
        <title>doctor</title>
        <path
        ...
        <path
                ...
                opacity="0.1"
        />
        <path d="M734,522.5S778.79,634,769.83,651.22s19.24,0,19.24,0Z" transform="translate(-56.94 -58.66)"
              opacity="0.1"/>
        <path
        ...
        <path
                ...
                fill="#e8f5ff"
        />
        <ellipse cx="489.51" cy="490.21" rx="20.13" ry="18.41" opacity="0.1"/>
        <path
        ...
        <rect
                ...
                fill="#e8f5ff"
        />
        <circle cx="476.17" cy="387.65" r="19.35" fill="#dd4b39"/>
        <circle cx="476.17" cy="387.65" r="16.07" fill="#e8f5ff"/>
        <path
        ...
        <path
                ...
                opacity="0.1"
        />
        <path d="M899.88,569.44c11.61,8.13,47.44,8.46,47.44,8.46Z" transform="translate(-56.94 -58.66)" opacity="0.1"/>
        <path
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <!-- <img src="../assets/images/undraw_doctor_kw5l.png" class="img-fluid" alt=""> -->
            </div>
            <div class="col-md-8">

                @guest
                    <form class="validate" method="post" action="{{ route('save-appointment') }}">
                        @csrf
                        <h1 class="title">{{ __('website.nav.get_appointment') }}
                            <span>{{ __('website.title_subtitle.get_appointment_subtitle') }}</span></h1>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="doctor_id" id="doctor" required
                                            class="form-control {{ $errors->has('doctor_id') ? ' parsley-error' : '' }}">
                                        <option value="">{{ __('doctor.select_doctor') }}</option>
                                        @foreach(\App\Models\Department::all() as $department)
                                            <optgroup label="{{ $department->title }}">
                                                @foreach($department->doctors as $doctor)
                                                    <option {{ old('doctor_id') ? decrypt(old('doctor_id')) ==  $doctor->id ? 'selected' : '' : '' }} {{ request()->query('doctor') ? setSelectOption(decrypt(request()->query('doctor')),$doctor->id) : '' }} value="{{ $doctor->encrypted_id }}">{{ $doctor->title }} {{ $doctor->full_name }}</option>
                                                @endforeach
                                            </optgroup>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('doctor_id'))
                                        <ul class="parsley-errors-list filled server-validation">
                                            <li class="parsley-required">{{ $errors->first('doctor_id') }}</li>
                                        </ul>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('schedule_date') ? ' parsley-error' : '' }}">
                                    <label for="">{{ __('website.form.appointment_time') }}</label>
                                    <input type="text" name="schedule_date" value="{{ old('schedule_date') }}"
                                           id="appointmentDate" autocomplete="off" required
                                           class="form-control datepicker {{ $errors->has('schedule_date') ? ' parsley-error' : '' }}"/>
                                    @if ($errors->has('schedule_date'))
                                        <ul class="parsley-errors-list filled server-validation">
                                            <li class="parsley-required">{{ $errors->first('schedule_date') }}</li>
                                        </ul>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">{{ __('website.form.appointment_time') }}</label>
                                    <select name="schedule_time" id="appointmentTime" required
                                            class="form-control {{ $errors->has('schedule_time') ? ' parsley-error' : '' }}">
                                        <option value="">Select schedule</option>
                                    </select>
                                    @if ($errors->has('schedule_time'))
                                        <ul class="parsley-errors-list filled server-validation">
                                            <li class="parsley-required">{{ $errors->first('schedule_time') }}</li>
                                        </ul>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="">{{ __('patient.sex') }}</label>
                                    <select name="sex" required
                                            class="form-control {{ $errors->has('sex') ? ' parsley-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('date_of_birth'))
                                        <ul class="parsley-errors-list filled server-validation">
                                            <li class="parsley-required">{{ $errors->first('date_of_birth') }}</li>
                                        </ul>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('cell_phone'))
                                        <ul class="parsley-errors-list filled server-validation">
                                            <li class="parsley-required">{{ $errors->first('cell_phone') }}</li>
                                        </ul>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" name="new_user" class="custom-control-input"
                                           {{ old('new_user') ? 'checked' : '' }}
                                           id="registerCheck"/>
                                    <label class="custom-control-label"
                                           for="registerCheck">{{ __('website.form.new_user') }}</label>
                                    <br>
                            ...
                            <button type="submit" class="btn btn-block btn-primary rounded-0">
                                {{ __('website.form.request_for_application') }}
                            </button>
                        </div>
                    </form>
                @else
                    <form action="{{ route('save-appointment') }}" method="post" class="validate">
                        @csrf
                        <h1 class="title">{{ __('website.nav.get_appointment') }}
                            <span>{{ __('website.title_subtitle.get_appointment_subtitle') }}</span></h1>
                        ...
                        <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="doctor_id" id="doctor" required
                                        ...
                                        @foreach(\App\Models\Department::all() as $department)
                                            <optgroup label="{{ $department->title }}">
                                                @foreach($department->doctors as $doctor)
                                                    <option {{ old('doctor_id') ? decrypt(old('doctor_id')) ==  $doctor->id ? 'selected' : '' : '' }}  value="{{ $doctor->encrypted_id }}">{{ $doctor->title }} {{ $doctor->full_name }}</option>
                                                @endforeach
                                            </optgroup>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group {{ $errors->has('schedule_date') ? ' parsley-error' : '' }}">
                                    <label for="">{{ __('website.form.appointment_date') }}</label>
                                    <input type="text" name="schedule_date" value="{{ old('schedule_date') }}"
                                           id="appointmentDate" autocomplete="off" required
                                           class="form-control datepicker {{ $errors->has('schedule_date') ? ' parsley-error' : '' }}"/>
                                    @if ($errors->has('schedule_date'))
...
<script>
    $(function () {
        $("#appointmentTime").on('focus', function (e) {
            e.preventDefault();
            ...
            $.ajax({
                url: '/schedule-details/date=' + date + '/doctor=' + doctor,
                method: 'GET',
                success: function (data) {
                    $('#appointmentTime').empty();
                    $.each(data.schedule_details, function (index, element) {
                        $('#appointmentTime').append(
                            $('<option>', {
                                value: element.start_time + ' To ' + element.end_time,
                    ...
                    if (data.schedule_details.length == 0) {
                        $('#appointmentTime').empty();
                        $('#appointmentTime').append(
                            $('<option>', {text: 'Schedule not found :( please pick other date for schedule'})
                        );
                    }
            ...
            // console.log({doctor: doctor, data: date});
