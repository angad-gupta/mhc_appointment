...
@section('content')
    @php
        $payment = \App\Models\PatientPayment::where('created_by', auth()->user()->id);
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-light-blue-gradient">
                ...
                <a href="{{ route('appointment.index') }}" class="small-box-footer">{{ __('dashboard.common.more_info') }} <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow-gradient">
                ...
                <a href="#" class="small-box-footer">{{ __('dashboard.common.more_info') }} <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
    ...
    <div class="box box-primary">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                @forelse($appointment->whereBetween('schedule_date',[\Carbon\Carbon::now()->toDateString(), \Carbon\Carbon::now()->addDay(3)->toDateString()])->get() as $key=>$appointment)
