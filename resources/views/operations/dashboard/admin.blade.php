...
@section('content')
    @php
        $payment = \App\Models\PatientPayment::query();
    ...
    @if(!config('installer.steps.mail'))
        <div class="box box-primary">
            <div class="box-body">

                <h4> {!! __('dashboard.admin.mail_message',['url'=> route('app.setup')]) !!}</h4>
            </div>
        </div>
    @endif
    ...
    <div class="box box-primary">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                @forelse($appointment->whereBetween('next_followup',[\Carbon\Carbon::now()->toDateString(), \Carbon\Carbon::now()->addDay(3)->toDateString()])->orderBy('schedule_date','asc')->get() as $ap)
