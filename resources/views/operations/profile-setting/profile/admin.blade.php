...
@section('content')
    <div class="box box-primary">
        ...
        <form action="{{ route('admin.update',['id'=>encrypt(auth()->user()->admin->id)]) }}" method="post" id="update_form" enctype="multipart/form-data">
            @csrf
            @method('put')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" id="" cols="30" rows="5" class="form-control">{{ auth()->user()->admin->address }}</textarea>
                                </div>
                            </div>
