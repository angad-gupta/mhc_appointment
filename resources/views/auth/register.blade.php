...
@endsection
@section('content')
<section class="g-bg-secondary" style="background-image: url(https://images.unsplash.com/photo-1587238226836-a2ead6e175df?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80)">
  <div class="container g-pt-30 g-pb-20">
    <div class="row justify-content-between">


      <div class="col-md-5 col-lg-5 flex-md-first g-mb-10 g-mt-10">
        <div class="mb-5">
      ...
      <div class="col-md-7 col-lg-7 flex-md-unordered align-self-center g-mb-80">
        <div class="u-shadow-v21 g-bg-white rounded g-pa-20">
          <header class="text-center mb-4">
            <h2 class="h2 g-color-black g-font-weight-600">Doctor Signup</h2>
          </header>
          @if ($errors->any())
