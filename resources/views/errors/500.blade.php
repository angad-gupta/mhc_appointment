...
@section('title') {{ __('website.error_page.titles.server_error') }} @endsection
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    >
                        ...
                        <rect x="271.60911" y="150" width="16" height="16" fill="#c6290d" opacity="0.4"/>
                        <rect x="294.60911" y="150" width="16" height="16" fill="#c6290d" opacity="0.8"/>
                        <rect x="317.60911" y="150" width="16" height="16" fill="#c6290d"/>
                        <rect x="271.60911" y="251" width="16" height="16" fill="#c6290d" opacity="0.4"/>
                        <rect x="294.60911" y="251" width="16" height="16" fill="#c6290d" opacity="0.8"/>
                        <rect x="317.60911" y="251" width="16" height="16" fill="#c6290d"/>
                        <rect x="271.60911" y="352" width="16" height="16" fill="#c6290d" opacity="0.4"/>
                        <rect x="294.60911" y="352" width="16" height="16" fill="#c6290d" opacity="0.8"/>
                        <rect x="317.60911" y="352" width="16" height="16" fill="#c6290d"/>
                ...
                <div class="col-md-6">
                    <div class="error-messages">
                        <h1 class="error-title">{{ __('website.error_page.codes.server_error') }}</h1>
                        <p>{{ __('website.error_page.messages.server_error') }}</p>
