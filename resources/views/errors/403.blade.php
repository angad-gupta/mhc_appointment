...
@section('title')
    {{ __('website.error_page.titles.permission_denied') }}
@endsection
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="error-messages">
                        <h1 class="error-title">{{ __('website.error_page.codes.permission_denied') }}</h1>
                        <p>{{ __('website.error_page.messages.permission_denied') }}</p>
