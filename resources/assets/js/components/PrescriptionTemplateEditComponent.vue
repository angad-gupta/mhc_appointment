...
<script>
    ...
    export default {
        name: "PrescriptionTemplateEditComponent",
        components: {
            PrescriptionHelperModel
        },
        props: {
            ...
            savePrescription: function () {
                ...
                if (this.drugBlocks.length != 0) {
                    if (this.template.name != '') {
                        axios.put('/prescription-template/' + this.template.id, {
                            drugs: this.drugBlocks,
                            inspection: this.inspection,
                            template: this.template
                        }).then((response) => {
                            this.$confirm({
                                title: 'Prescription template update!',
...
width=0,height=0,left=-1000,top=-1000`;
        ...
        mounted() {
            ...
            axios.get('/vue/my-template-by-id/' + this.template_id).then((response) => {
